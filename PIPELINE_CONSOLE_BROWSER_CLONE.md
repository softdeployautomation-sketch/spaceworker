...
| BUILD-5 | **G1 / TASK_105** resource governor / queue — **ASSIGNED TO CLINE 2026-09-26** (owner priority pick, over BUILD-2 which is deferred instead) | not started | nothing caps concurrency or enforces fairness as the clone fleet grows |
